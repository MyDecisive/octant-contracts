...
const file_octant_v1alpha_argocd_service_proto_rawDesc = "" +
	"\n" +
	"#octant/v1alpha/argocd_service.proto\x12\x0eoctant.v1alpha\x1a\x1bbuf/validate/validate.proto\x1a\x1bgoogle/protobuf/empty.proto\"\x7f\n" +
	"\x15TestConnectionRequest\x120\n" +
