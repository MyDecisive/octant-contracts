...
const file_octant_v1alpha_connection_service_proto_rawDesc = "" +
	"\n" +
	"'octant/v1alpha/connection_service.proto\x12\x0eoctant.v1alpha\x1a\x1bbuf/validate/validate.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x19octant/v1alpha/type.proto\"h\n" +
	"\x15GetConnectionResponse\x12O\n" +
	"\x0fconnection_data\x18\x01 \x01(\v2\x1e.octant.v1alpha.ConnectionDataB\x06\xbaH\x03\xc8\x01\x01R\x0econnectionData\"k\n" +
