...
import { Duration, FieldDescriptorProto_Type, FieldMask, FieldOptions, Message, MessageOptions, OneofOptions, proto2, Timestamp } from "@bufbuild/protobuf";
...
export class StringRules extends Message<StringRules> {
  ...
  static readonly fields: FieldList = proto2.util.newFieldList(() => [
    ...
    { no: 37, name: "protobuf_fqn", kind: "scalar", T: 8 /* ScalarType.BOOL */, oneof: "well_known" },
    { no: 38, name: "protobuf_dot_fqn", kind: "scalar", T: 8 /* ScalarType.BOOL */, oneof: "well_known" },
 ...
 */
export class FieldMaskRules extends Message<FieldMaskRules> {
  /**
  ...
  static equals(a: FieldMaskRules | PlainMessage<FieldMaskRules> | undefined, b: FieldMaskRules | PlainMessage<FieldMaskRules> | undefined): boolean {
    return proto2.util.equals(FieldMaskRules, a, b);
  }
}
